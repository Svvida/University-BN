...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240811103949_EventFeatureExtension")]
    partial class EventFeatureExtension
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.EventEntities.EventOrganizer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Events_Organizers", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.EventEntities.EventOrganizerEvents", b =>
                {
                    ...
                    b.ToTable("Events_Organizers_Events", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.ExternalEntities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domain.Entities.ExternalEntities.ExternalParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("External_Participants", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.ExternalEntities.ExternalParticipantComanies", b =>
                {
                    ...
                    b.HasKey("CompanyId", "ExternalParticipantId");

                    b.HasIndex("ExternalParticipantId");

                    b.ToTable("External_Participants_Companies", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.EventEntities.EventOrganizer", b =>
                {
                    b.HasOne("Domain.Entities.AccountEntities.UserAccount", "Account")
                        ...
                        .HasForeignKey("Domain.Entities.EventEntities.EventOrganizer", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.EventEntities.EventOrganizerEvents", b =>
                {
                    b.HasOne("Domain.Entities.EventEntities.Event", "Event")
                        .WithMany("EventOrganizersEvents")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.EventEntities.EventOrganizer", "EventOrganizer")
                        .WithMany("EventOrganizersEvents")
            ...
            modelBuilder.Entity("Domain.Entities.ExternalEntities.Company", b =>
                {
                    b.HasOne("Domain.Entities.AccountEntities.UserAccount", "Account")
                        .WithOne("Company")
                        .HasForeignKey("Domain.Entities.ExternalEntities.Company", "AccountId");
            ...
            modelBuilder.Entity("Domain.Entities.ExternalEntities.ExternalParticipant", b =>
                {
                    b.HasOne("Domain.Entities.AccountEntities.UserAccount", "Account")
                        .WithOne("ExternalParticipant")
                        .HasForeignKey("Domain.Entities.ExternalEntities.ExternalParticipant", "AccountId");
            ...
            modelBuilder.Entity("Domain.Entities.ExternalEntities.ExternalParticipantComanies", b =>
                {
                    b.HasOne("Domain.Entities.ExternalEntities.Company", "Company")
                        .WithMany("ExternalParticipantComanies")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ExternalEntities.ExternalParticipant", "ExternalParticipant")
                        .WithMany("ExternalParticipantComanies")
            ...
            modelBuilder.Entity("Domain.Entities.EventEntities.Event", b =>
                {
                    b.Navigation("EventOrganizersEvents");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ExternalEntities.Company", b =>
                {
                    b.Navigation("ExternalParticipantComanies");
                });
